...
func _on_inventory_open_inventory():
	...
	move_child($select2, 1)	
func _on_select2_picked():
	occupied = false
...
func _on_select2_picked2():
	occupied = false
	remove_child(character)	


func _on_select2_picked3():
	occupied = false
	remove_child(character)	


func _on_select2_picked4():
	occupied = false
	remove_child(character)	


func _on_select2_picked5():
	occupied = false
	remove_child(character)	


func _on_select2_picked6():
	occupied = false
	remove_child(character)	


func _on_select2_picked7():
	occupied = false
	remove_child(character)	
